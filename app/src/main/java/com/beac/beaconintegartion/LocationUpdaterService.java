...
public class LocationUpdaterService extends Service {
    ...
    public void onCreate() {
        ...
        Toast.makeText(LocationUpdaterService.this, "sdfdsdf", Toast.LENGTH_SHORT).show();
        Log.d("Loc","es");
        super.onCreate();
    }
    ...
    Runnable mHandlerTask = new Runnable(){
        ...
        public void run() {
            if (!isRunning) {
                startListening();
                Toast.makeText(LocationUpdaterService.this, "sadsdasadsd dsfsdf", Toast.LENGTH_SHORT).show();
            }
